...
export const ItineraryView: React.FC<{ data: AppData; setData: any; selectedDayIndex: number; setSelectedDayIndex: any }> = ({ data, setData, selectedDayIndex, setSelectedDayIndex }) => {
    ...
    return (
        <div className="space-y-4 pb-24 animate-in">
            ...
            {isDayModalOpen && (
                <div className="fixed inset-0 bg-milk-tea-900/60 z-[100] flex items-center justify-center backdrop-blur-sm p-4">
                    <div className="bg-white w-full max-w-md rounded-[32px] p-6 space-y-4 shadow-2xl animate-in">
            ...
            {isEventModalOpen && (
                <div className="fixed inset-0 bg-milk-tea-900/60 z-[100] flex items-center justify-center backdrop-blur-sm p-4">
                    <div className="bg-white w-full max-w-md rounded-[32px] p-6 overflow-y-auto max-h-[85dvh] space-y-4 shadow-2xl animate-in">
...
export const SpotsView: React.FC<{ data: AppData; setData: (d: AppData) => void }> = ({ data, setData }) => {
    ...
    return (
        <div className="space-y-4 pb-24 animate-in">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-milk-tea-900/60 z-[100] flex items-center justify-center backdrop-blur-sm p-4">
                    <div className="bg-white w-full max-w-md rounded-[32px] p-6 space-y-4 shadow-2xl animate-in overflow-y-auto max-h-[85dvh]">
            ...
            {integratingSpot && (
                <div className="fixed inset-0 bg-milk-tea-900/60 z-[110] flex items-center justify-center backdrop-blur-sm p-4">
                    <div className="bg-white w-full max-w-md rounded-[32px] p-6 space-y-4 shadow-2xl animate-in overflow-y-auto max-h-[75dvh]">
